...
Assert-MatchText 'compact title reveal uses tracked native tooltip popup' $deskband '(?s)void\s+ShowCompactTitlePopup\(.*?TTM_UPDATETIPTEXTW.*?TTM_TRACKPOSITION.*?TTM_TRACKACTIVATE'
